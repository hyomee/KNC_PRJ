...
<!-- 공통코드 관리 등록 모달 -->
<div class="modal fade management_billitem" id="modalAddBillItem" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content" style="font-size:12px;padding:20px;color:#222;">
		<div class="modal-header">
			<h3 style="text-align:center">요금항목관리 등록</h3>
		</div>
		<div class="modal-body" id="divModalBillItem">
			<form id="frmModalBillItem" name="frmModalBillItem">
