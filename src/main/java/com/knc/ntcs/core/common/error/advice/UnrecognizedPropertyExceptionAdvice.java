...
public class UnrecognizedPropertyExceptionAdvice {
  ...
  public ResponseEntity<ResponseDTO> UnrecognizedPropertyException(UnrecognizedPropertyException ex,
                                                          WebRequest request) {
    ...
    BizExceptionUtils.fillInStackTrace(fillInStackTrace,"UnrecognizedPropertyException", ex.fillInStackTrace().toString());
