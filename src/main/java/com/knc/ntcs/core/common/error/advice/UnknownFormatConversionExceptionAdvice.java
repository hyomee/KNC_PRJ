...
public class UnknownFormatConversionExceptionAdvice {
  ...
  public ResponseEntity<ResponseDTO> ClassCastException(UnknownFormatConversionException ex,
                                                        WebRequest request) {
    ...
    BizExceptionUtils.fillInStackTrace(fillInStackTrace,"UnknownFormatConversionException", ex.fillInStackTrace().toString());
