package ntcs.web.management.code.controller;
...
public class ManagementCodeController {
	...
	public String getManagementCodeList(ModelMap model) throws Exception {
		...
		map.put("commonGroupCd", "1");
		map.put("commonGroupCdNm", "서비스요금항목");
		...
		map2.put("commonGroupCd", "1");
		map2.put("commonGroupCdNm", "서비스요금항목");
		...
		map3.put("commonGroupCd", "1");
		map3.put("commonGroupCdNm", "서비스요금항목");
